...
int absdist_main(int argc, char* argv[]) {
    ...
    if (!showHelp) {
        ...
        AbsoluteDistance *rd = new AbsoluteDistance(bedAFile, 
                                                    bedBFile,
                                                    summary);
        delete rd;
        return 0;
...
void absdist_help(void) {
    ...
    cerr << "\nTool:    bedtools absdist" << endl;
    cerr << "Version: " << VERSION << "\n";    
    cerr << "Summary: Calculate the absolute distance distribution "
    ...
    cerr << "\t-detail\t"       << "Instead of a summary, report the absolute" 
